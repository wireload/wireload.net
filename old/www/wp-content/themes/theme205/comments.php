<div class="content_txt" style="padding-top:0px; line-height:normal;"><?php // Do not delete these lines
...
<p><input name="submit" type="image" id="submit" tabindex="5" src="<?php bloginfo('stylesheet_directory'); ?>/images/submit.jpg" />
